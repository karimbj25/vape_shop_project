...
class __TwigTemplate_92974bc4ea93ca0c8dd5e9a72366a809 extends Template
{
...
<li>
    <a ";
        ...
        if ( !Twig\Extension\CoreExtension::testEmpty((isset($context["label"]) || array_key_exists("label", $context) ? $context["label"] : (function () { throw new RuntimeError('Variable "label" does not exist.', 12, $this->source); })()))) {
            ...
            yield ">";
            (((isset($context["renderLabelRaw"]) || array_key_exists("renderLabelRaw", $context) ? $context["renderLabelRaw"] : (function () { throw new RuntimeError('Variable "renderLabelRaw" does not exist.', 12, $this->source); })())) ? (yield (isset($context["label"]) || array_key_exists("label", $context) ? $context["label"] : (function () { throw new RuntimeError('Variable "label" does not exist.', 12, $this->source); })())) : (yield $this->env->getRuntime('Twig\Runtime\EscaperRuntime')->escape((isset($context["label"]) || array_key_exists("label", $context) ? $context["label"] : (function () { throw new RuntimeError('Variable "label" does not exist.', 12, $this->source); })()), "html", null, true)));
            yield "</span>";
        }
        // line 13
        yield "</a>
...
";
    ...
    {
        return array (  127 => 13,  119 => 12,  114 => 11,  111 => 10,  107 => 8,  45 => 1,);
    }
...
", "@EasyAdmin/components/ActionMenu/ActionList/Item.html.twig", "C:\\xampp\\htdocs\\symfonyproject\\vendor\\easycorp\\easyadmin-bundle\\templates\\components\\ActionMenu\\ActionList\\Item.html.twig");
    }
}
